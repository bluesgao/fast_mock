...
// 从配置文件中获取Float64类型的值
func (c *Conf) GetFloat64(name string) float64 {
	value := c.Get(name)
	switch value := value.(type) {
	case string:
...
func (c *Conf) GetStruct(name string, s interface{}) interface{} {
	d := c.Get(name)
	switch d.(type) {
	case string:
		c.setField(s, name, d)
...
func (c *Conf) mapToStruct(m map[interface{}]interface{}, s interface{}) interface{} {
...
// 这部分代码是重点，需要多看看
func (c *Conf) setField(obj interface{}, name string, value interface{}) error {
